///////////////////////////////////////////////////
//
// Attract-Mode Frontend - "Carrier1" module
//
// by Oomek 2017
//
/*
...
local carrier = Carrier1( 0, 400, 1920, 300, 5, 3, 20 )
or
local carrier = Carrier1( 0, 400, 1920, 300, 5, 3, 20, "selector.png", "background.png" )
...
Carrier1( carrierPosX, carrierPosY, carrierWidth, carrierHeight, tilesCount, tilesOffscreen, tilePadding[, selectorImage, backgroundImage] ) 

    carrierPosX - x position of Carrier1 surface in pixels
    carrierPosY - y position of Carrier1 surface in pixels
    carrierWidth - width of the Carrier1 surface in pixels
    carrierHeight - height of the Carrier1 surface in pixels
    ...
    selectorBackground - png that will be stretched across the whole Carrier1 surface
...
FUNCTIONS:    
    ...
    carrier.set_background_color( red, green, blue )  - sets the color of the Carrier1 surface background if no file was specified
...
class Carrier1 {
    ...
    constructor( carrierPosX, carrierPosY, carrierWidth, carrierHeight, tilesCount, _tilesOffscreen, _tilePadding, ... ) {
        ...
        for( local i = 0; i < tilesTotal; i++ ) {
            local obj = surface.add_artwork( "flyer" )
...
animation.add( PropertyAnimation( selector, 
