...
fe.do_nut( fe.module_dir + "renderer.nut");
...
fe.do_nut( fe.module_dir + "emitter.nut")
fe.do_nut( fe.module_dir + "particle.nut")
fe.do_nut( fe.module_dir + "modifiers/accelerate.nut")
fe.do_nut( fe.module_dir + "modifiers/color.nut")
fe.do_nut( fe.module_dir + "modifiers/field.nut")
fe.do_nut( fe.module_dir + "modifiers/force.nut")
fe.do_nut( fe.module_dir + "modifiers/life.nut")
fe.do_nut( fe.module_dir + "modifiers/rate.nut")
fe.do_nut( fe.module_dir + "modifiers/scale.nut")
fe.do_nut( fe.module_dir + "modifiers/velocity.nut")
